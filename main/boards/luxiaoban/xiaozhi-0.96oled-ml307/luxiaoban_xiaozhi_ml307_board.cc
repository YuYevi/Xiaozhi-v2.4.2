...
#define TAG "LuxiaobanXiaozhiOledMl307"

class LuxiaobanXiaozhiOledMl307 : public DualNetworkBoard {
private:
    ...
    // Register the lamp as an MCP tool.
    void InitializeTools() { static LampController lamp(LAMP_GPIO); }

public:
    LuxiaobanXiaozhiOledMl307()
...
DECLARE_BOARD(LuxiaobanXiaozhiOledMl307);
