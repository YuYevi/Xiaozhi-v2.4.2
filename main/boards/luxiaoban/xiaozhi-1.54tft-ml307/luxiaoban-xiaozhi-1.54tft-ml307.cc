...
#define TAG "LuxiaobanXiaozhiTftMl307"

class LuxiaobanXiaozhiTftMl307 : public DualNetworkBoard {
private:
    Button boot_button_;
    ...
    void InitializePowerSaveTimer() {
        ...
        power_save_timer_->OnShutdownRequest([this]() {
            ...
            // Hold the latch level during deep sleep.
            rtc_gpio_hold_en(GPIO_NUM_21);
            esp_lcd_panel_disp_on_off(panel_, false);  // Turn the display off.
...
DECLARE_BOARD(LuxiaobanXiaozhiTftMl307);
